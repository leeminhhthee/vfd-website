...
const photoTabs = [
  { label: "Các đội tuyển", slug: "doi-tuyen" },
...
const mockImages = [
  { id: 1, url: "/gallery/volleyball-team-photo.jpg", alt: "Đội tuyển Quốc gia", tag: "doi-tuyen" },
  { id: 2, url: "/gallery/volleyball-event.jpg", alt: "Giải Vô địch Quốc gia", tag: "quoc-gia" },
  { id: 3, url: "/gallery/volleyball-female-team.jpg", alt: "Đội tuyển Trẻ thi đấu", tag: "tre" },
  { id: 4, url: "/gallery/volleyball-international-match.jpg", alt: "Giải Quốc tế lớn", tag: "doi-tuyen" },
  { id: 5, url: "/gallery/volleyball-league.jpg", alt: "Khán giả và giải đấu", tag: "quoc-gia" },
  { id: 6, url: "/gallery/volleyball-match.jpg", alt: "Hoạt động cộng đồng", tag: "cong-dong" },
  { id: 7, url: "/gallery/volleyball-team-photo.jpg", alt: "Hoạt động tại bãi biển", tag: "cong-dong" },
  { id: 8, url: "/gallery/volleyball-team.jpg", alt: "Ăn mừng chiến thắng", tag: "tre" },
]
